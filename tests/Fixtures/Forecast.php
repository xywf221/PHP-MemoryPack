...
final class Forecast
{
    ...
    #[MemoryPackField(order: 1, type: Type::LIST, elementClass: Temperature::class)]
    public array $hourly;

    #[MemoryPackField(order: 2, type: Type::DICT, keyType: Type::STRING, elementClass: Temperature::class)]
    public array $byCity;
}
